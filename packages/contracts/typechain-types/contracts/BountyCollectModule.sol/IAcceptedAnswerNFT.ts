...
export interface IAcceptedAnswerNFTInterface extends Interface {
...
export interface IAcceptedAnswerNFT extends BaseContract {
  connect(runner?: ContractRunner | null): IAcceptedAnswerNFT;
  waitForDeployment(): Promise<this>;

  interface: IAcceptedAnswerNFTInterface;
